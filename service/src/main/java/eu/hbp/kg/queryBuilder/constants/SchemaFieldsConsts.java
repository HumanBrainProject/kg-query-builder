package eu.hbp.kg.queryBuilder.constants;

public class SchemaFieldsConsts {
    public static final String USER_ID = "https://schema.hbp.eu/users/nativeId";
    public static final String USER_PICTURE = "https://schema.hbp.eu/users/picture";
    public static final String ID = "http://schema.org/identifier";
