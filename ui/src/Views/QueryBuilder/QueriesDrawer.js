...
const QueriesDrawer = observer(() => {
  ...
  return (
    <div className={`${classes.container} ${queryBuilderStore.showQueries?"show":""}`}>
      <button className={classes.toggle} onClick={handleToggleDrawer}><FontAwesomeIcon icon="search"/></button>
            ...
            queryBuilderStore.fetchQueriesError?
              ...
              !queryBuilderStore.hasQueries?
                <div className={classes.noQueries} >
                  ...
                  <button onClick={handleFetchSavedQueries} title="Refresh"><FontAwesomeIcon icon="redo-alt"/></button>
                </div>
                :
                <React.Fragment>
